...
const ASSETS=['./','./index.html','./app.js','./db.js','./offline-core.js','./shift-core.js','./finance-core.js','./report-core.js','./report-ui.js','./translations.js','./version.json','./manifest.webmanifest'];
